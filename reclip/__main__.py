...
def main():
    ...
    parser_serve.add_argument('--host', default='127.0.0.1', help='host addr')
    parser_serve.add_argument('--port', default=8000, help='port')
    parser_serve.set_defaults(fn=cmd_serve)

    parser_set = subparsers.add_parser('set', help='see `set -h`')
    parser_set.add_argument('--host', default='127.0.0.1', help='host addr')
    parser_set.add_argument('--port', default=8000, help='port')
    ...
    parser_get.add_argument('--host', default='127.0.0.1', help='host addr')
    parser_get.add_argument('--port', default=8000, help='port')
    parser_get.set_defaults(fn=cmd_get)

    parser_delete = subparsers.add_parser('delete', help='see `delete -h`')
    parser_delete.add_argument('--host', default='127.0.0.1', help='host addr')
    parser_delete.add_argument('--port', default=8000, help='port')
